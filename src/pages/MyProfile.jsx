    ...
    <div className="page-container">
      <div className="page-header">
        ...
        <div style={{ display:'flex', gap:12 }}>
          ...
          <button className="filter-btn" style={{ background:'#10B981', color:'#fff', border:'none' }}
            onClick={() => { setProfile({ ...form }); setEditing(false); alert('✅ Profile updated!'); }}>
            💾 Save
          </button>
        </div>
      </div>
    ...
    <div className="page-container">
      ...
      <div className="profile-card">
        ...
        <div className="profile-details">
          ...
          <div className="detail-row"><span>📚 Department:</span><span>{profile.department}</span></div>
